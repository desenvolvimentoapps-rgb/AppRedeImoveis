...
function createClient() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://ceevcdnttlbjpucrdqew.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_-tXsMuwfJRlSEw6oY8LxIA_1XubSkTa"));
}
...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        refreshProfile: async ()=>{
            const { createClient } = await __turbopack_context__.A("[project]/src/lib/supabase/client.ts [app-client] (ecmascript, async loader)");
...
"[project]/src/hooks/useAuthProvider.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAuthProvider() {
    _s();
    const { setProfile, setIsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAuthProvider.useEffect": ()=>{
            let isMounted = true;
            const fetchProfile = {
                "useAuthProvider.useEffect.fetchProfile": async ()=>{
                    try {
                        // Small delay to ensure browser auth client is fully ready
                        await new Promise({
                            "useAuthProvider.useEffect.fetchProfile": (resolve)=>setTimeout(resolve, 100)
                        }["useAuthProvider.useEffect.fetchProfile"]);
                        if (!isMounted) return;
                        const { data: { user } } = await supabase.auth.getUser();
                        if (user && isMounted) {
                            const { data: profile } = await supabase.from('profiles').select('*').eq('id', user.id).single();
            ...
            const { data: { subscription } } = supabase.auth.onAuthStateChange({
                "useAuthProvider.useEffect": async (event, session)=>{
...
_s(useAuthProvider, "94QtvhuLwS30J85GaaeiIFlThsY=", false, function() {
    return [
...
"[project]/src/hooks/useCMS.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
const useCMSStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set)=>({
        fields: [],
        menus: [],
...
"[project]/src/hooks/useCMSScanner.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function useCMSScanner() {
    _s();
    const { setFields, setMenus, setIsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCMS$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCMSStore"])();
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCMSScanner.useEffect": ()=>{
            const fetchConfig = {
                "useCMSScanner.useEffect.fetchConfig": async ()=>{
                    const [fieldsRes, menusRes] = await Promise.all([
                        supabase.from('cms_fields').select('*').eq('is_active', true),
                        supabase.from('cms_menus').select('*').eq('is_active', true).order('display_order', {
                            ascending: true
                        })
                    ]);
            ...
            }["useCMSScanner.useEffect.fetchConfig"];
            fetchConfig();
        }
    }["useCMSScanner.useEffect"], [
        supabase,
...
_s(useCMSScanner, "O5ecI6IYYkptWahbpJ9jpyZnD+4=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuthProvider$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useAuthProvider.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCMSScanner$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useCMSScanner.ts [app-client] (ecmascript)");
...
function Providers({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuthProvider$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthProvider"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCMSScanner$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCMSScanner"])();
...
_s(Providers, "k5AXzrJgD21ebipvOGst4ZCgN1c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuthProvider$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthProvider"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCMSScanner$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCMSScanner"]
    ];
});
_c = Providers;
var _c;
...
//# sourceMappingURL=src_d6800b2d._.js.map